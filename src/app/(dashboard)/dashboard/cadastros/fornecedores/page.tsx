        ...
        >
          <Card className="modal-content w-full max-w-lg my-auto max-h-[90vh] overflow-y-auto" padding="lg">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-[var(--font-size-small)] font-medium text-[var(--text-secondary)] mb-1">Início contrato</label>
                  <input
                    type="date"
                    value={form.contrato_inicio ?? ""}
                    onChange={(e) => setForm((f) => ({ ...f, contrato_inicio: e.target.value || null }))}
                ...
                <div>
                  <label className="block text-[var(--font-size-small)] font-medium text-[var(--text-secondary)] mb-1">Fim contrato</label>
                  <input
                    type="date"
                    value={form.contrato_fim ?? ""}
                    onChange={(e) => setForm((f) => ({ ...f, contrato_fim: e.target.value || null }))}
                    className="w-full px-3 py-2 rounded-[var(--radius-md)] border border-[var(--border-medium)] bg-[var(--surface-card)] text-[var(--font-size-small)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]/30"
                  />
                </div>
              </div>
